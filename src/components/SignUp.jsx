...
const SignUp = () => {
  ...
  <>
  <span className=' absolute top-40 left-[10rem] md:top-0 md:left-[0] text-4xl font-bold '> Create Account</span>
    ...
    <div className='flex'>
         ...
         *Required Valid Email
          ...
          <button className = 'absolute top-[52%] right-2' onClick = {handleShowPassword} >   {passwordShow?<FaRegEye size ={20}/>:<FaRegEyeSlash size={20}/>}</button>
            ...
            <div className='text-[0.75rem]'> Already a Member? <Link to='/userauth/login' className='text-blue-500 hover:underline'>Login</Link></div>
          </form>
